...
import { Wall, Opening, GNNData, GNNNode, GNNEdge, Point, ProjectLabel, GNNSemanticLabel } from '../types';
import { distance, getLineIntersection, isPointOnSegment } from './geometry';
 ...
 */
export const compileGraphData = (walls: Wall[], openings: Opening[], labels: ProjectLabel[] = []): GNNData => {
